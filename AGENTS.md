...
- **Avoid** using `npm` / installing `npm` packages. If you must, you must get explicit confirmation from the user first, even if operating in `--dangerously-skip-permissions` mode.
